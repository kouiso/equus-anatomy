...
export default tseslint.config(
  { ignores: ['dist', 'node_modules', 'coverage', 'playwright-report', 'test-results', '.expo', 'expo-env.d.ts', 'src/web'] },
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            ...
            { group: ['@tanstack/*', 'expo-router', 'expo-router/*'], message: 'core/ はルータに依存せん' },
